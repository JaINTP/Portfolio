              ...
              <TabsContent value="prep" className="outline-none space-y-8 animate-in fade-in duration-500">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        <div className="lg:col-span-4 space-y-6">
                            <Card className="bg-white/[0.02] border border-white/5 p-6 rounded-3xl space-y-6 shadow-inner">
              ...
              <TabsContent value="buffer" className="outline-none animate-in fade-in duration-500">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    <div className="lg:col-span-5 space-y-6">
                        <Card className="bg-white/[0.02] border-white/5 rounded-3xl p-8 space-y-8">
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    <Label className="text-[10px] font-black uppercase text-gray-500">Substance pKa</Label>
                                    <Input type="number" value={bufferInput.pka} onChange={e=>setBufferInput({...bufferInput, pka: e.target.value})} className="h-12 bg-black border-white/10 font-bold text-xl rounded-2xl text-cyan-400" />
                                </div>
              ...
              <TabsContent value="optics" className="outline-none animate-in fade-in duration-500">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-7">
                        {beerResult ? (
                            <div className="space-y-6 animate-in slide-in-from-right-4 duration-500">
                                <Card className="bg-cyan-500 text-black border-none rounded-3xl p-10 relative overflow-hidden shadow-2xl shadow-cyan-500/20">
                                    ...
                                    <h3 className="text-2xl font-black mb-2 text-center">{beerResult.label}</h3>
                                    <p className="text-7xl font-black tracking-tighter text-center leading-none">{beerResult.res.toExponential(4)}</p>
                                </Card>
                            </div>
                        ) : (
                            <div className="h-full min-h-[400px] border-2 border-dashed border-white/5 rounded-[40px] flex flex-col items-center justify-center text-gray-700 space-y-4">
                        ...
                        {assayResult && (
                            <div className="space-y-6 animate-in slide-in-from-right-4 duration-500">
                                <Card className="bg-cyan-500 text-black border-none rounded-3xl p-10 flex flex-col justify-center items-center relative overflow-hidden shadow-2xl shadow-cyan-500/20">
                                    ...
                                    <p className="text-[100px] font-black tracking-tighter mb-4 leading-none">{assayResult.toFixed(2)}<span className="text-2xl ml-4 font-bold">M</span></p>
                                </Card>
                            </div>
                        ) : (
                            <div className="h-full min-h-[300px] border-2 border-dashed border-white/5 rounded-[40px] flex flex-col items-center justify-center text-gray-700">
